...
abstract class BaseNotification(protected val context: Context){
    protected var notificationBuilderTarget: NotificationTarget = getNotificationTarget()
    protected val notificationBuilderData: NotificationData = getNotificationData()
