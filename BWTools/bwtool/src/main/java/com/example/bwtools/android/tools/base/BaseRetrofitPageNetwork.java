...
import com.example.bwtools.android.tools.base.mvp.network.BaseRetrofitPageInterface;
...
public abstract class BaseRetrofitPageNetwork<doInBackground,OnPost,CallType extends BaseJsonPage> extends AsyncTask<doInBackground,Integer, ArrayList<OnPost>> implements BaseRetrofitPageInterface<ArrayList<OnPost>,CallType> {
    ...
    private retrofit2.Response<CallType> response;
    ...
    public BaseRetrofitPageNetwork(Context context, PageManager pageManager) {
        this.context = context;
